...
SetupIconFile=MeroHosterIcon.ico
UninstallDisplayIcon={app}\MeroHosterIcon.ico
...
Source: "MeroHosterIcon.ico"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\MeroHoster"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\backend\mero_host.py"""; IconFilename: "{app}\MeroHosterIcon.ico"
Name: "{autodesktop}\MeroHoster"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\backend\mero_host.py"""; IconFilename: "{app}\MeroHosterIcon.ico"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\Classes\Directory\shell\MeroHoster"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\MeroHosterIcon.ico"""
...
Root: HKCU; Subkey: "Software\Classes\Directory\Background\shell\MeroHoster"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\MeroHosterIcon.ico"""
