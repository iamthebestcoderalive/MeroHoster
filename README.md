<div>
  <img style="text-align: right;"src="vercel-landing/mero_hoster_logo.png" alt="MeroHoster Banner" width="400" />
  <img style="text-align: left;"src="vercel-landing/mero_client_logo.png" alt="MeroClient Banner" width="400" />
</div>
...
- **One-Click Tunnels (Playit.gg):** Automatically expose your server to the world without ever touching your router's port-forwarding settings. 
- **Modrinth Installer:** Search, download, and install plugins and mods directly from the dashboard.
...
- **Built-in Console:** Send commands and read server logs instantly from your browser.
